...
{
    echo "Usage: /usr/local/bin/php build_includes <root_path> <outfile>\n";
}
...
?>';
    ...
    public function run($rootPath,$outfile,$cacheKey=null)
    {/*{{{*/
    ...
    {/*{{{*/
        ...
        $cacheKey = $cacheKey.":".substr(time(),-4);
